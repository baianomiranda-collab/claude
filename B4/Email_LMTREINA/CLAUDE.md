...
## Credenciais
Leia o arquivo `C:\Claude\B4\Email_LMTREINA\.env` no início de cada execução para obter:
...
### Grupo PQ
- Domínios: @grupopq.com, @pernambucoquimica.com.br, @pgquimica.com.br, @symbolus.com.br, @totvs.com.br, @vozdocliente.totvs.com.br, @sofisa.com.br, @procenge.movidesk.com, @bv.com.br, @bwa.global, @abcbrasil.com.br
- Mover para a pasta: **GRUPOPQ**
- EXCEÇÃO: helpdesk@grupopq.com → mover para **GRUPOPQ HELPDESK**
- EXCEÇÃO: jetson@grupopq.com → mover para **GRUPOPQ JETSON**
...
### XP
- Domínios: @vortx.com.br, @xpi.com.br, @xpeducacao.com.br, @xpe.edu.br, @cuoreplatform.com, @emkt.b3.com.br
...
### QIVE PQ
- Domínio: @qive.com.br
- Mover para a pasta: **QIVE_PQ**

### Pessoal
- Domínios: @safra.com.br, @uber.com, @comunicacao.inter.co, @ars3.acsoluti.com.br, @info.nissan.com.br, @jtnindustria.com.br, @bipa.app, @nomadglobal.com, @email.claude.com, @trello.com, @amazon.com.br, @acesseseucondominio.com.br, @meudemonstrativo.com.br, @asaas.com, @shop.tiktok.com, @contato.clubedevantagenshapvida.com.br, sistemaorganon@gmail.com, @cesar.school, @notification.circle.so, @comunicacao.meliuz.com.br, @certisign.com.br, @techmetria.com.br
...
### Emails para Deletar
- Domínio: @tgfinancas.com.br, @freesider.com.br, @oracle.netsuite.com, @portalerp.com, @linkedin.com,
@emkt.zylumi.com, @danomoral.com.br, @ola.soustix.com.br, @gateway.cabparticipacoes.com.br,
@pravoce.petz.com.br, @novidades.petz.com.br, @promo.rentcars.com, @emailactivecampaign.duxnutrition.com, @gympass.com, @blockbusterfilmsuk.com, @ekyte.com,
...
@grupolegale.com,
@webpros.com, @sercorban.com, @infobradesco.com.br, @promolinks.com,
@novidadeslojasrenner.com.br, @hyperbeyond.com, @solucx.com.br, @uraprods.com, @riocorban.com,
@reachgccpeopledirect.com, @localiq.com, @academyalz.com, @congresidentes.com,
@duogourmet.com.br, @wizard.com.br, @m.intvl.com.au, @news.iplace.com.br,
@excrh.com.br, @primeira.app, @speedentrega.com, @marketing.burgerking.com.br, @lupartners.com.br,
@thanced.com, @trademarketme.com, @soluti.com.br, @objetivasolucao.com.br,
@sensoarz.com, @reachpeopledirect.com, @duolingo.com, @boadigital.com.br, @userede.com.br,
@skyone.solutions, @infoemail.microsoft.com
- Nota: spam com domínio aleatório tipo Natura Online usa padrão credit-segur — verificar via includes('credit-segur') na função classify.
- Nota: guiasimpl usa subdomínios variáveis (ex: guiasimplesnacional.com.br) — verificar via includes('guiasimpl') na função classify.
- Nota: Prevent Senior / spam de saúde usa domínios aleatórios com padrões hces e wesl-saf — verificar via includes('hces') e includes('wesl-saf') na função classify.
- Nota: speedentrega.com usa subdomínios variáveis (ex: email19.speedentrega.com) — verificar via includes('speedentrega.com') na função classify.
...
- Nota: grupolegale.com usa subdomínios numerados variáveis (ex: email5.grupolegale.com) — verificar via includes('grupolegale.com') na função classify.
...
- Domínios: @lmtreina.com.br, @comunicacao.sympla.com.br, @grupofleury.com.br, @labmm.com.br
- Regra: Manter na caixa de entrada, **sem mover**
- Razão: Emails internos, resultados de exames (Fleury/LABMM) e notificações de eventos (Sympla)
...
onde turno = "Manhã" (execução 07h) ou "Tarde" (execução 13h)

"""
=============================================================
  RELATORIO DE ORCAMENTOS - CASH-UP (PERNAMBUCO QUIMICA / GRUPO PQ)
...
URL = os.getenv("CASHUP_PQ_URL")
LOGIN_USER = os.getenv("CASHUP_PQ_USER")
LOGIN_PASS = os.getenv("CASHUP_PQ_PASS")
WEBMAIL_USER = os.getenv("CASHUP_WEBMAIL_PQ_USER")
WEBMAIL_PASS = os.getenv("CASHUP_WEBMAIL_PQ_PASS")
GMAIL_USER = os.getenv("CASHUP_WEBMAIL_GMAIL_PQ_USER")
GMAIL_PASS = (os.getenv("CASHUP_WEBMAIL_GMAIL_PQ_PASS") or "").replace(" ", "")
EMAIL_PARA_LIST = [e.strip() for e in (os.getenv("CASHUP_EMAIL_PARA_PQ") or "").split(",") if e.strip()]
